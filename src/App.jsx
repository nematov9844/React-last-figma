...
function Posts() {
  return (
    <div className="px-3 md:px-5 max-w-[1440px] py-3 flex flex-col gap-4 bg-[#EDF7FA] ">
...
function Works() {
  return (
    <div className="px-3 md:px-5 max-w-[1440px] flex flex-col gap-4">
